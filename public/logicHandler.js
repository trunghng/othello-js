...
function flip_discs(grid, row, col, color) {
...
module.exports.get_valid_moves = get_valid_moves;
module.exports.flip_discs = flip_discs;
module.exports.calculate_score = calculate_score;
